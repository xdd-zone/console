...
export const getThemeById = (id: string): CatppuccinTheme | undefined => {
  return catppuccinThemes.find((theme) => theme.id === id)
}

export const getThemeColors = (id: string): CatppuccinColor[] | null => {
