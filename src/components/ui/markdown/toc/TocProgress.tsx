...
export const TocProgress: FC<TocProgressProps> = ({ progress }): ReactElement => {
  ...
  return (
    <div className="flex items-center gap-2 text-[var(--color-text-secondary)]/70 dark:text-white/70">
      ...
      <span className="text-sm font-medium text-[var(--color-text-secondary)]/80 dark:text-white/80">{clamped}%</span>
    </div>
  )
}
