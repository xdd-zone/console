    ...
    >
      <div className="relative flex h-screen flex-col items-center justify-center">
        ...
        <div className="absolute top-4 right-4 z-20 flex items-center gap-2 md:top-6 md:right-6">
          <div className="text-cat-muted cursor-pointer rounded-lg p-2 transition-all duration-200 hover:bg-white/20">
            <LanguageButton />
          </div>
          <div className="text-cat-muted cursor-pointer rounded-lg p-2 transition-all duration-200 hover:bg-white/10">
            <ThemeToggle />
          </div>
        </div>
        ...
        <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-center md:mx-auto md:max-w-md md:px-6 md:py-8 lg:max-w-lg xl:max-w-xl">
          <div className="border-cat bg-surface-elevated/30 md:bg-surface-elevated/50 flex h-full w-full flex-col justify-center p-6 shadow-lg backdrop-blur-xs md:h-auto md:rounded-xl md:p-8 lg:px-12 lg:py-10">
